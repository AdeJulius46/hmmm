...
const Sidebar = ({ isSideBarOpen, setIsSideBarOpen }) => {
   ...
   return (
      <>
         <nav
            className={`${isSideBarOpen ?" w-[80px] ":" w-[250px]" } bg-white pl-3 py-6 h-screen fixed overflow-y-auto z-20 transition-transform transform lg:transform-none no-scrollbar  ${
